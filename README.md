...
<!-- > Answer: The benefit of using client side routing is that we are able to connect diffrent pages or components with out having the page to refresh or make too many server side request. -->
